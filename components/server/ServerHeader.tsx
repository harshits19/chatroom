  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="focus:outline-none" asChild>
        <button className="flex items-center justify-between w-full h-12 px-4 font-semibold transition border-b-2 text-primary border-neutral-200 dark:border-neutral-800 hover:bg-zinc-700/5 dark:hover:bg-zinc-700/50">
      ...
      <DropdownMenuContent className="w-56 text-xs font-medium text-accent-foreground space-y-0.5">
        {isModerator && (
          <DropdownMenuItem className="px-3 py-2 text-sm text-indigo-400 cursor-pointer focus:text-white focus:bg-theme-foreground">
