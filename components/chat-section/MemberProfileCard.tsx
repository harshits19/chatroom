    ...
    <Popover>
      ...
      <PopoverContent side={side} align={align} className="p-0 rounded-lg bg-[#EAECEE] dark:bg-popover">
        <div className="w-full h-full">
          <div
            style={{ backgroundImage: `url(${member.profile.imageUrl})` }}
            className="relative w-full rounded-t-lg h-[60px] bg-[image:var(--image-url)] bg-muted before:content-[''] before:absolute before:bg-cover before:blur-[50px] before:scale-[3] before:inset-0">
            <div className="absolute border-[6px] rounded-full size-20 left-4 top-4 border-popover">
              <Image
